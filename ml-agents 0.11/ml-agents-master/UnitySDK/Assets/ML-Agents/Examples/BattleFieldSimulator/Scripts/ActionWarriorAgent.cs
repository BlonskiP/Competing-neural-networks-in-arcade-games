...
public class ActionWarriorAgent : Agent
{
  ...
  //  private RayPerception3D rayPerc;
    ...
    public override void InitializeAgent()
    {
        ...
        sight = GetComponentInChildren<WarriorRayPerception>();
      ...
      //  rayPerc = GetComponentInChildren<RayPerception3D>();
    ...
    public void Death()
    {
        WarriorStats.team.TeamMembers.Remove(this);
    ...
    private void AddVectorObs(List<Observation> ObsVector)
    {
        foreach (var observation in ObsVector)
        {
            ...
            if (observation.gameObject != null)
            {
                ...
                {
                    ActionWarriorAgent agent = observation.gameObject.GetComponentInParent<ActionWarriorAgent>();
                    if(agent!=null)
                    {
                        AddVectorObs(0.1f);
